...
const uiMessages = {
  en: {
    ...
    "settings.ai.mermaidPromptsTitle": "Mermaid Prompt Templates",
    "settings.ai.drawioPromptsTitle": "Draw.io Prompt Templates",
    "settings.ai.enabled": "Enable AI+",
    "settings.ai.disabledNote": "Enable AI+ to configure the API connection and prompts.",
    "settings.ai.baseUrl": "API Base URL",
    "settings.ai.model": "Model",
    "settings.ai.token": "API Token",
    "settings.ai.promptFamilyMermaid": "Mermaid",
    "settings.ai.promptFamilyDrawio": "Draw.io",
    "settings.ai.promptPresetDefault": "Default",
    "settings.ai.promptPresetCustom": "Custom",
    "settings.ai.systemPrompt": "System Prompt Template",
    "settings.ai.userPrompt": "User Prompt Template",
    "settings.ai.drawioSystemPrompt": "Draw.io System Prompt Template",
    "settings.ai.drawioUserPrompt": "Draw.io User Prompt Template",
    ...
    "ai.copy": "Copy",
    "ai.apply": "Apply",
    "drawio.ai.label": "Draw.io AI+",
    "drawio.ai.button.new": "Draw.io AI Generate",
    "drawio.ai.button.modify": "Draw.io AI Modify",
    "drawio.ai.closeAria": "Close Draw.io AI+",
    "drawio.ai.title": "Generate Draw.io XML from text",
    "drawio.ai.context.new": "Describe the diagram you want and AI+ will draft native draw.io XML.",
    "drawio.ai.context.merge": "Describe the change you want and AI+ will revise the current draw.io XML.",
    "drawio.ai.mode.new": "New",
    "drawio.ai.mode.modify": "Modify",
    "drawio.ai.prompt.label": "Prompt",
    "drawio.ai.prompt.placeholder": "Describe the components, labels, groups, and connections you want in the draw.io diagram.",
    "drawio.ai.status.idle": "Idle",
    "drawio.ai.status.idleMessage": "Waiting for your prompt.",
    "drawio.ai.status.generating": "Generating",
    "drawio.ai.status.generatingMessage": "Generating native draw.io XML...",
    "drawio.ai.status.drawingMessage": "Drawing diagram on the canvas...",
    "drawio.ai.status.repairing": "Repairing",
    "drawio.ai.status.repairingMessage": "The first draft failed local draw.io validation. Repairing it now...",
    "drawio.ai.status.valid": "Validated",
    "drawio.ai.status.validMessage": "Generated draw.io XML passed local validation.",
    "drawio.ai.status.invalid": "Needs Fix",
    "drawio.ai.status.invalidMessage": "AI+ returned draw.io XML that still failed local validation.",
    "drawio.ai.status.appliedMessage": "AI+ draw.io preview has been kept on the current canvas.",
    "drawio.ai.result": "Result",
    "drawio.ai.result.title": "Generated Draw.io XML",
    "drawio.ai.result.previewSummary": "Preview applied to the canvas. Apply to keep it, or Cancel to restore the previous diagram.",
    "drawio.ai.result.validSummary": "Validated draw.io XML.",
    "drawio.ai.result.repairedSummary": "Validated draw.io XML after one automatic repair pass.",
    "drawio.ai.result.invalidSummary": "AI+ returned draw.io XML, but local validation still failed.",
    "drawio.ai.result.model": "model",
    "drawio.ai.error.emptyPrompt": "Enter a prompt before generating draw.io XML.",
    "drawio.ai.error.settingsIncomplete": "Enable AI+ and finish the API settings before generating draw.io XML.",
    "drawio.ai.error.mergeUnavailable": "There is no current draw.io diagram to update.",
    "drawio.ai.error.emptyDiagram": "Generated draw.io XML loaded successfully, but it does not contain any visible diagram content.",
    "drawio.ai.error.applyUnavailable": "The current Draw.io AI result cannot be applied.",
  ...
  "zh-CN": {
    ...
    "settings.ai.mermaidPromptsTitle": "Mermaid Prompt 模板",
    "settings.ai.drawioPromptsTitle": "Draw.io Prompt 模板",
    "settings.ai.enabled": "启用 AI+",
    "settings.ai.disabledNote": "开启 AI+ 后，再配置 API 连接和提示词。",
    "settings.ai.baseUrl": "API Base URL",
    "settings.ai.model": "模型",
    "settings.ai.token": "API Token",
    "settings.ai.promptFamilyMermaid": "Mermaid",
    "settings.ai.promptFamilyDrawio": "Draw.io",
    "settings.ai.promptPresetDefault": "默认",
    "settings.ai.promptPresetCustom": "自定义",
    "settings.ai.systemPrompt": "系统 Prompt 模板",
    "settings.ai.userPrompt": "用户 Prompt 模板",
    "settings.ai.drawioSystemPrompt": "Draw.io 系统 Prompt 模板",
    "settings.ai.drawioUserPrompt": "Draw.io 用户 Prompt 模板",
    "settings.ai.promptNote":
    ...
    "ai.apply": "应用",
    "drawio.ai.label": "Draw.io AI+",
    "drawio.ai.button.new": "Draw.io AI 生成",
    "drawio.ai.button.modify": "Draw.io AI 修改",
    "drawio.ai.closeAria": "关闭 Draw.io AI+",
    "drawio.ai.title": "通过文本生成 Draw.io XML",
    "drawio.ai.context.new": "描述你想要的图，AI+ 会直接生成原生 draw.io XML。",
    "drawio.ai.context.merge": "描述你想要的修改，AI+ 会直接调整当前 draw.io XML。",
    "drawio.ai.mode.new": "新建",
    "drawio.ai.mode.modify": "修改",
    "drawio.ai.prompt.label": "提示词",
    "drawio.ai.prompt.placeholder": "描述你想要的 draw.io 图中的组件、标签、分组和连线。",
    "drawio.ai.status.idle": "空闲",
    "drawio.ai.status.idleMessage": "等待输入提示词。",
    "drawio.ai.status.generating": "生成中",
    "drawio.ai.status.generatingMessage": "正在生成原生 draw.io XML...",
    "drawio.ai.status.drawingMessage": "正在把流程图绘制到画布上...",
    "drawio.ai.status.repairing": "修复中",
    "drawio.ai.status.repairingMessage": "首轮结果未通过本地 draw.io 校验，正在修复...",
    "drawio.ai.status.valid": "已校验",
    "drawio.ai.status.validMessage": "生成的 draw.io XML 已通过本地校验。",
    "drawio.ai.status.invalid": "需修复",
    "drawio.ai.status.invalidMessage": "AI+ 返回的 draw.io XML 仍未通过本地校验。",
    "drawio.ai.status.appliedMessage": "AI+ 预览结果已确认保留在当前画布上。",
    "drawio.ai.result": "结果",
    "drawio.ai.result.title": "生成的 Draw.io XML",
    "drawio.ai.result.previewSummary": "预览结果已应用到画布。点击应用保留，点击取消恢复到之前的图。",
    "drawio.ai.result.validSummary": "已校验的 draw.io XML。",
    "drawio.ai.result.repairedSummary": "经过一次自动修复后通过校验的 draw.io XML。",
    "drawio.ai.result.invalidSummary": "AI+ 返回了 draw.io XML，但本地校验仍未通过。",
    "drawio.ai.result.model": "模型",
    "drawio.ai.error.emptyPrompt": "生成 draw.io XML 前请输入提示词。",
    "drawio.ai.error.settingsIncomplete": "请先启用 AI+ 并完成 API 设置，再生成 draw.io XML。",
    "drawio.ai.error.mergeUnavailable": "当前没有可更新的 draw.io 图。",
    "drawio.ai.error.emptyDiagram": "生成的 draw.io XML 虽然可以加载，但其中没有任何可见图形内容。",
    "drawio.ai.error.applyUnavailable": "当前 Draw.io AI 结果无法应用。",
