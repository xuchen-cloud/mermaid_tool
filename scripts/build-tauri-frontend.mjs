...
const drawioVendorPath = path.join(vendorRoot, "drawio");
const distVendorPath = path.join(distRoot, "vendor");
...
async function buildFrontend() {
  ...
  await ensureDir(distVendorPath);
  ...
  await cp(drawioVendorPath, path.join(distVendorPath, "drawio"), {
    recursive: true
  });
